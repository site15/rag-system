...
Дата публикации: Mon, 25 Nov 2024 08:37:45 GMT
[Оригинал статьи](https://habr.com/ru/articles/861064/?utm_campaign=861064&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
На каждом фронтенд запросе к бэкенду запрашивается информация по профилю пользователя из базы данных, это создает дополнительную нагрузку на базу данных и увеличивает время ответа бэкенда, для ускорения подобных запросов можно кэшировать ответ базы данных. В этом посте я подключу `Redis` к проекту и настрою кэширование данных через `@nestjs-mod/cache-manager`. Проект можно запускать в `Docker Compose` и `Kubernetes`.

[Читать далее](https://habr.com/ru/articles/861064/?utm_campaign=861064&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)25  ноя  2024 в 08:37# Кэширование информации в Redis на NestJS

Время на прочтение14 минОхват и читатели3.1K[NestJS * ](/ru/hubs/nestjs/)[Node.JS * ](/ru/hubs/nodejs/)[TypeScript * ](/ru/hubs/typescript/)ТуториалRecovery ModeПредыдущая статья: Интеграция внешнего файлового сервера https://min.io в фулстек приложение на NestJS и Angular
...
- [redis](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[redis])

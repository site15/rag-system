...
Дата публикации: Mon, 16 Sep 2024 05:17:20 GMT
[Оригинал статьи](https://habr.com/ru/articles/843572/?utm_campaign=843572&amp;utm_source=habrahabr&amp;utm_medium=rss)
...
[Читать далее](https://habr.com/ru/articles/843572/?utm_campaign=843572&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)16  сен  2024 в 05:17# Доступ к сайту на NestJS и Angular по доменному имени c SSL — сертификатом в Kubernetes через Ingress

Время на прочтение9 минОхват и читатели665[Angular * ](/ru/hubs/angular/)[GitHub * ](/ru/hubs/github/)[Kubernetes * ](/ru/hubs/kubernetes/)[NestJS * ](/ru/hubs/nestjs/)[TypeScript * ](/ru/hubs/typescript/)ТуториалПредыдущая статья: Установка Kubernetes через MicroK8s и настройка деплоя NestJS и Angular приложений
...
Текущий результат работы CI/CD: https://github.com/nestjs-mod/nestjs-mod-fullstack/actions/runs/10877250887 Текущий сайт: https://fullstack.nestjs-mod.com

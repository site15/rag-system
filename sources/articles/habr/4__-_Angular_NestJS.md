...
Дата публикации: Mon, 16 Dec 2024 07:29:11 GMT
[Оригинал статьи](https://habr.com/ru/articles/866858/?utm_campaign=866858&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
![undefined](https://habrastorage.org/getpro/habr/upload_files/868/6bb/d11/8686bbd11b29be8179621be5432b12eb.png)Этот пост не претендует на масштабность, но поскольку я последовательно документирую все этапы разработки бойлерплейта в формате статей, решил описать и эту задачу.
...
[Читать далее](https://habr.com/ru/articles/866858/?utm_campaign=866858&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)16  дек  2024 в 07:29# Интеграция и сохранение выбранного языка пользователя в базу данных в фулстек-приложении на «Angular» и «NestJS»

Время на прочтение12 минОхват и читатели399[NestJS * ](/ru/hubs/nestjs/)[Angular * ](/ru/hubs/angular/)[TypeScript * ](/ru/hubs/typescript/)[Node.JS * ](/ru/hubs/nodejs/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалПредыдущая статья: Поддержка временных зон в фулстек-приложении на основе NestJS и Angular: работа с REST и WebSockets
...
- [i18n](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[i18n])
...
- [e2e-тесты](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[e2e-%D1%82%D0%B5%D1%81%D1%82%D1%8B])

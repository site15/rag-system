...
Дата публикации: Tue, 03 Dec 2024 11:50:50 GMT
[Оригинал статьи](https://habr.com/ru/articles/863396/?utm_campaign=863396&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
В этом посте я добавлю в `NestJS`-приложении валидацию `REST`-запросов и их отображение в формах `Angular`-приложения.

[Читать далее](https://habr.com/ru/articles/863396/?utm_campaign=863396&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)3  дек  2024 в 11:50# Валидация REST-запросов в NestJS-приложении и отображение ошибок в формах Angular-приложения

Время на прочтение11 минОхват и читатели668[NestJS * ](/ru/hubs/nestjs/)[Angular * ](/ru/hubs/angular/)[Node.JS * ](/ru/hubs/nodejs/)[TypeScript * ](/ru/hubs/typescript/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалПредыдущая статья: Получение серверного времени через WebSockets и отображение его в Angular-приложении
...
- [validation](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[validation])

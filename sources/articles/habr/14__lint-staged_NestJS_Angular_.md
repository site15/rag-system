...
Дата публикации: Tue, 17 Sep 2024 19:19:06 GMT
[Оригинал статьи](https://habr.com/ru/articles/844148/?utm_campaign=844148&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
![undefined](https://habrastorage.org/getpro/habr/upload_files/b17/184/5bf/b171845bf01e4451025312e0645204dc.png)Так как версионирование через плагин `nx-semantic-release` происходит путем анализа изменений по связанным `Typescript`-импортам, то нам нужно минимизировать эти изменения, для этого в проект подключаем `lint-staged` и добавляем строгости в `Typescript`-код.

[Читать далее](https://habr.com/ru/articles/844148/?utm_campaign=844148&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)17  сен  2024 в 19:19# Добавляем lint-staged в NestJS и Angular приложения, включаем семантическое версионирование фронтенда

Время на прочтение14 минОхват и читатели838[NestJS * ](/ru/hubs/nestjs/)[Angular * ](/ru/hubs/angular/)[Nx * ](/ru/hubs/nx/)[TypeScript * ](/ru/hubs/typescript/)[DevOps * ](/ru/hubs/devops/)ТуториалПредыдущая статья: Семантическое версионирование NestJS и Angular приложений в NX-монорепозитории
...
Текущий результат работы CI/CD: https://github.com/nestjs-mod/nestjs-mod-fullstack/actions/runs/10904254598 Текущий сайт: https://fullstack.nestjs-mod.com

...
Дата публикации: Sun, 29 Dec 2024 19:44:48 GMT
[Оригинал статьи](https://habr.com/ru/articles/870854/?utm_campaign=870854&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
![undefined](https://habrastorage.org/getpro/habr/upload_files/db8/5d3/651/db85d3651d1a2705f97fffe80eef6446.png)В этой статье я расскажу о добавлении нового поля `workUntilDate` с типом `timestamp(6)` в таблицу `Webhook` базы данных `Webhook`.
...
[Читать далее](https://habr.com/ru/articles/870854/?utm_campaign=870854&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)29  дек  2024 в 19:44# Конвертация даты по временной зоне пользователя в «NestJS», а также ввод и отображение даты в «Angular»

Время на прочтение14 минОхват и читатели812[Angular * ](/ru/hubs/angular/)[NestJS * ](/ru/hubs/nestjs/)[Node.JS * ](/ru/hubs/nodejs/)[TypeScript * ](/ru/hubs/typescript/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалПредыдущая статья: Интеграция и сохранение выбранного языка пользователя в базу данных в фулстек-приложении на "Angular" и "NestJS"
...
Пример обновления `DTO`-файла libs/feature/webhook/src/lib/generated/rest/dto/webhook.dto.ts
...
```
Пример обновления `Prisma`-схемы libs/feature/webhook/src/prisma/schema.prisma
...
Обновляем файл libs/feature/webhook-angular/src/lib/services/webhook-form.service.ts
...
Создаем файл libs/feature/webhook-angular/src/lib/services/webhook-mapper.service.ts
...
Пример добавления пайпа apps/client/src/app/app.component.html
...
Пример обновления теста apps/client-e2e/src/ru-example.spec.ts
...
- [timezone](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[timezone])
...
- [tz](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[tz])
- [ant](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[ant])
- [ng](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[ng])
- [zorro](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[zorro])
- [formly](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[formly])

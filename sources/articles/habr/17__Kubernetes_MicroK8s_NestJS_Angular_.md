...
Дата публикации: Sat, 14 Sep 2024 11:49:07 GMT
[Оригинал статьи](https://habr.com/ru/articles/843332/?utm_campaign=843332&amp;utm_source=habrahabr&amp;utm_medium=rss)
...
[Читать далее](https://habr.com/ru/articles/843332/?utm_campaign=843332&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)14  сен  2024 в 11:49# Установка Kubernetes через MicroK8s и настройка деплоя NestJS и Angular приложений

Время на прочтение15 минОхват и читатели1.7K[Kubernetes * ](/ru/hubs/kubernetes/)[GitHub * ](/ru/hubs/github/)[NestJS * ](/ru/hubs/nestjs/)[Angular * ](/ru/hubs/angular/)[TypeScript * ](/ru/hubs/typescript/)ТуториалПредыдущая статья: Ускорение деплоя NestJS и Angular с помощью общественных Github-раннеров и создания промежуточных Docker-образов
...
- Запускаем скрипт создания дополнительных переменных окружения;

- Копируем файлы с шаблонами конфигураций запуска приложений и инфраструктуры, при этом заменяем во всех скопированных файлах все найденные переменные окружения;

- Запускаем инфраструктуру через "Docker Compose" (база данных + миграции);

- Создаем и запускаем приложения в Kubernetes;

- Запускам E2E-тесты через "Docker Compose".
...
Текущий результат работы CI/CD: https://github.com/nestjs-mod/nestjs-mod-fullstack/actions/runs/10861775039 Текущий сайт: http://194.226.49.162:30222/
...
https://nestjs.com - официальный сайт фреймворка https://nestjs-mod.com - официальный сайт дополнительных утилит http://fullstack.nestjs-mod.com:30222 - сайт из поста https://github.com/nestjs-mod/nestjs-mod-fullstack - проект из поста https://github.com/nestjs-mod/nestjs-mod-fullstack/commit/4b1c3c7d6bcb0b3bac479d5f414bbefd49aa5e87 - изменения

Теги:- [kubernetes](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[kubernetes])
...
Хабы:- [Kubernetes](/ru/hubs/kubernetes/)
- [GitHub](/ru/hubs/github/)
- [NestJS](/ru/hubs/nestjs/)
- [Angular](/ru/hubs/angular/)

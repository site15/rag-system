...
Дата публикации: Thu, 12 Dec 2024 20:40:59 GMT
[Оригинал статьи](https://habr.com/ru/articles/866204/?utm_campaign=866204&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
![undefined](https://habrastorage.org/getpro/habr/upload_files/930/5cc/fa9/9305ccfa977c8530e52746e977bf26d2.png)В этой статье я хотел бы поделиться своим опытом по внедрению поддержки временных зон в фулстек-приложение, построенное на `NestJS` и `Angular`. Мы узнаем, как сохранить настройки таймзоны пользователя в базе данных и правильно использовать их при взаимодействии с сервером через `REST` и веб-сокеты.

[Читать далее](https://habr.com/ru/articles/866204/?utm_campaign=866204&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)12  дек  2024 в 20:40# Поддержка временных зон в фулстек-приложении на основе NestJS и Angular: работа с REST и WebSockets

Время на прочтение26 минОхват и читатели951[NestJS * ](/ru/hubs/nestjs/)[Angular * ](/ru/hubs/angular/)[TypeScript * ](/ru/hubs/typescript/)[Node.JS * ](/ru/hubs/nodejs/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалПредыдущая статья: Добавление поддержки нескольких языков в NestJS и Angular приложениях

...
Дата публикации: Mon, 26 Aug 2024 12:34:01 GMT
[Оригинал статьи](https://habr.com/ru/articles/838620/?utm_campaign=838620&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
Подключение генератора Swagger документации к бэкенду. Подключение https://www.npmjs.com/package/prisma-class-generator для генерации DTO из Prisma - схемы. Создание nx библиотеки для работы с бэкендом. Подключение https://www.npmjs.com/package/@openapitools/openapi-generator-cli для генерации SDK для работы с бэкендом.

[Читать далее](https://habr.com/ru/articles/838620/?utm_campaign=838620&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)26  авг  2024 в 12:34# Добавление Swagger документации в NestJS-mod приложение и генерация REST-клиента для Angular-приложения

Время на прочтение18 минОхват и читатели743[Angular * ](/ru/hubs/angular/)[NestJS * ](/ru/hubs/nestjs/)[TypeScript * ](/ru/hubs/typescript/)[Node.JS * ](/ru/hubs/nodejs/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалRecovery ModeПредыдущая статья: Подключение PrismaORM в NestJS-mod приложение и проверка его работы через REST
...
https://nestjs.com - официальный сайт фреймворка https://nestjs-mod.com - официальный сайт дополнительных утилит https://github.com/nestjs-mod/nestjs-mod-fullstack - проект из поста https://github.com/nestjs-mod/nestjs-mod-fullstack/commit/0353b23b1b65d1ff8e6e5f6185e235bbe05cf523 - коммит на текущие изменения

Теги:- [nestjs](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[nestjs])
- [angular](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[angular])

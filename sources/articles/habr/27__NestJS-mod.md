...
Дата публикации: Thu, 08 Aug 2024 21:15:51 GMT
[Оригинал статьи](https://habr.com/ru/articles/834888/?utm_campaign=834888&amp;utm_source=habrahabr&amp;utm_medium=rss)

**Описание из RSS:**
![undefined](https://habrastorage.org/getpro/habr/upload_files/594/cec/70d/594cec70dad04014d31bea81746b116a.png)После многих лет написания различных проектов на NestJS и Angular, я решил переписать группу проектов из репозитория https://github.com/rucken и использовать текущий стиль кодирования, он не сильно поменялся, просто стало меньше однотипного кода.
...
[Читать далее](https://habr.com/ru/articles/834888/?utm_campaign=834888&amp;utm_source=habrahabr&amp;utm_medium=rss#habracut)

[](/ru/users/kaufmanendy/)[kaufmanendy](/ru/users/kaufmanendy/)8  авг  2024 в 21:15# Создание пустого проекта с помощью NestJS-mod

Время на прочтение12 минОхват и читатели764[Node.JS * ](/ru/hubs/nodejs/)[TypeScript * ](/ru/hubs/typescript/)[NestJS * ](/ru/hubs/nestjs/)[Тестирование веб-сервисов * ](/ru/hubs/web_testing/)ТуториалПосле многих лет написания различных проектов на NestJS и Angular, я решил переписать группу проектов из репозитория https://github.com/rucken и использовать текущий стиль кодирования, он не сильно поменялся, просто стало меньше однотипного кода.
...
https://nestjs.com - официальный сайт фреймворка https://nestjs-mod.com - официальный сайт дополнительных утилит https://github.com/nestjs-mod/nestjs-mod-fullstack - проект из поста https://github.com/nestjs-mod/nestjs-mod-fullstack/commit/5fab437a5d4a9122aee021f3a49756419dc8dee2 - коммит на текущие изменения
...
- [node](/ru/search/?target_type=posts&amp;order=relevance&amp;q=[node])

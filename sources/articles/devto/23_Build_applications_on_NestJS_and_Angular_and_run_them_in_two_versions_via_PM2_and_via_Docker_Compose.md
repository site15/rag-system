...
Published: 2024-08-20T09:14:02.044Z
Tags: pm2, docker, fullstack, nestjs
[Original Article](https://dev.to/endykaufman/build-applications-on-nestjs-and-angular-and-run-them-in-two-versions-via-pm2-and-via-docker-compose-1g1e)
...
The NestJS-mod application has a special section for connecting this type of modules Core modules, but at this stage, to simplify understanding, such global things will be connected at the `AppModule` level.
...
- Install npm devDependencies necessary to generate additional code and packages

- Generating SDK for Prisma

- Removing unnecessary packages from node_modules

- Copy node_modules and applications to a new clean image
...
- Container for creating application databases and filling them through application migrations

- Backend application

- Nginx with built-in frontend files for routing requests to the backend

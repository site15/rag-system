...
-- CreateIndex
CREATE INDEX "IDX_CHAT_MESSAGE_DOCUMENT_EMBEDDINGS__MESSAGE_ID" ON "ChatMessageDocumentEmbedding"("messageId");
...
-- CreateIndex
CREATE INDEX "IDX_CHAT_LLM_REQUESTS__MESSAGE_ID" ON "ChatLlmRequest"("messageId");

-- CreateIndex
CREATE INDEX "IDX_CHAT_LLM_REQUESTS__DIALOG_HISTORY" ON "ChatLlmRequest"("dialogId", "messageId");
...
-- AddForeignKey
ALTER TABLE "ChatMessageDocumentEmbedding" ADD CONSTRAINT "FK_CHAT_MESSAGE_DOCUMENT_EMBEDDINGS__MESSAGE_ID" FOREIGN KEY ("messageId") REFERENCES "ChatMessage"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "ChatLlmRequest" ADD CONSTRAINT "FK_CHAT_LLM_REQUESTS__MESSAGE_ID" FOREIGN KEY ("messageId") REFERENCES "ChatMessage"("id") ON DELETE SET NULL ON UPDATE NO ACTION;
